...
export default function Genesis() {
  const [ref, inView] = useInView({
    triggerOnce: true,
    threshold: 0.2,
    // Add a root margin to trigger slightly earlier
    rootMargin: '-50px 0px',
  });

  return (
    <section className="px-6 md:px-[80px] py-[160px] grid grid-cols-1 md:grid-cols-2 gap-[32px] items-center overflow-hidden min-h-screen">
      {/* Text Content */}
      <motion.div 
        ref={ref}
      ...
      >
        ...
        <h3 className="font-['Bodoni_Moda'] text-[48px] leading-[56px] tracking-[0.05em] mb-8 font-normal text-[#e4e2e1]">
      ...
      >
        <div className="relative film-grain-image">
          <img 
